...
/******************************************************************************
  ...
  ./CrackLc3 \$6\$AS\$rO24ikvdmsECaZyd.CCYw0tZbkaFSRVtP6.wo5x0YpAj0x9MM0.yUnzNyO5.7S3nL3lhe51pFAJPsiXqDUhOw./
...
void crack(char *salt_and_encrypted){
  ...
  char plain[6];   // The combination of letters currently being checked // Please modifiy the number when you enlarge the encrypted password.
  plain[5] = '\0'; // Put end of string marker on password
